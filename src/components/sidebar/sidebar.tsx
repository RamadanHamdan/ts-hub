      ...
      >
          ...
          {sections.map((section) => {
            ...
            return (
              <div key={section.title} className='space-y-1'>
                ...
                >
                  <div
                    className={`flex-shrink-0 w-6 h-6 flex items-center justify-center mr-4 
                  ...
                  <div
                    className={`flex-1 flex items-center justify-between overflow-hidden ${labelVisibility} transition-opacity duration-300`}
                  >
                    ...
                    return (
                      ...
                      >
                        <div className='flex-shrink-0 w-5 h-5 flex items-center justify-center mr-4'>
                          <ItemIcon
                            className={`w-4 h-4 ${active ? 'text-blue-900' : 'text-white/40 group-hover/item:text-white'}`}
                          />
                        </div>
                        <span
                          className={`whitespace-nowrap font-medium text-base ${labelVisibility} transition-opacity duration-300 ${active ? 'text-blue-900' : ''}`}
                        >
                          {item.label}
                        </span>
                      </Link>
        ...
        <div className='mt-auto border-t border-white/10 bg-black/20 dark:bg-black/40'>
          ...
          <div className='px-4 py-4 flex items-center overflow-hidden'>
            ...
            <div
              className={`ml-4 ${labelVisibility} transition-opacity duration-300 flex flex-col min-w-0`}
            >
          ...
          <div className='p-3 flex gap-2'>
            ...
            >
              ...
              <span
                className={`font-bold text-[10px] tracking-widest ${labelVisibility} transition-opacity duration-300 overflow-hidden whitespace-nowrap`}
              >
                LOGOUT
              </span>
            </button>
